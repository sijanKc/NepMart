        ...
        >
            <div className="relative h-64 overflow-hidden bg-gray-50">
                ...
                <div className="absolute top-3 right-3 flex flex-col gap-2 translate-x-12 group-hover:translate-x-0 transition-transform duration-300">
                    <button className="p-2 bg-white rounded-full shadow-md hover:text-primary transition-colors">
                        <Heart size={20} />
                    </button>
                </div>
                {product.discount && (
            ...
            <div className="p-5">
                ...
                <div className="flex items-center justify-between mt-4">
                    ...
                    <button className="p-3 bg-primary text-white rounded-xl hover:bg-red-600 transition-colors shadow-lg shadow-red-200">
